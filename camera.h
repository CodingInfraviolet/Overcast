...
///A class to encapsulate a camera in the game world. Warning: Rotation uses internal facilities overriding default!
...
///Initialises the camera and sets the position to the given values.
