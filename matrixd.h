...
Removed stdlib dependancy.
Added literal matrix constructors.
Added short vectors.

Add sum() and product() methods.
Add casting!
Overload proper operators

Unrelated:
ostream::str() freezes object.Memory leak!!!
*/
...
namespace math
{
	...
	mat4 createRotationMatrix(matReal angle, const vec3& axis);
